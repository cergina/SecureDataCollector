...
@WebServlet(name = "GET_ControllerUnits", urlPatterns = {"/controller-units"})
public class GET_ControllerUnits extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws IOException {
        try {
            ...
            // Base
            StringBuilder document = CoreBuilder.GenerateBaseOfSite("Controller Units");

            // Tables
            ArrayList<T_ControllerUnit> arr = ControllerUnit.retrieveAll(conn, ps, rs);
