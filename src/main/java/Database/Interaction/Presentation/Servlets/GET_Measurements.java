...
@WebServlet(name = "GET_Measurements", urlPatterns = {"/measurements"})
public class GET_Measurements extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws IOException {
        try {
            ...
            // Base
            StringBuilder document = CoreBuilder.GenerateBaseOfSite("Measurements");
