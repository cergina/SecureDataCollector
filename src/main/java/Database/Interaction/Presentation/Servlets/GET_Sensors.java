...
@WebServlet(name = "GET_Sensors", urlPatterns = {"/sensors"})
public class GET_Sensors extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws IOException {
        try {
            ...
            // Base
            StringBuilder document = CoreBuilder.GenerateBaseOfSite("Sensors");
