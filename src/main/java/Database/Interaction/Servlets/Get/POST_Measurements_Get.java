...
@WebServlet(name = "POST_Measurements_Get", urlPatterns = {"/api/measurement-byId"})
public class POST_Measurements_Get extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws IOException {
        try {
            // parse
            JSONObject json = JSONHelper.ReturnBodyIfValid(req, "POST", "/api/measurement-byId");
