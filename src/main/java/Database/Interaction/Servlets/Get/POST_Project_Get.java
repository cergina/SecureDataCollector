...
@WebServlet(name = "POST_Project_Get", urlPatterns = {"/api/project-byId"})
public class POST_Project_Get extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws IOException {
        try {
            // parse
            JSONObject json = JSONHelper.ReturnBodyIfValid(req, "POST", "/api/project-byId");
