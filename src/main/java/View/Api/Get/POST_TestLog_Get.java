...
public class POST_TestLog_Get extends POST_Database_Interaction {
    ...
    protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws IOException {
        try {
            ...
            T_TestLog ret_ect = InteractionWithDatabase.retrieve(dbProvider.getConn(), dbProvider.getPs(), dbProvider.getRs(), DbEntity.ReturnUnusable(T_TestLog.class), json.getInt(T_TestLog.DBNAME_ID));
