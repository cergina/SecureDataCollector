...
public class GET_CentralUnits extends GET_Database_Interaction {
    ...
    protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws IOException {
        try {
            ...
            List<T_CentralUnit> arr = InteractionWithDatabase.retrieveAll(dbProvider.getConn(), dbProvider.getPs(), dbProvider.getRs(), DbEntity.ReturnUnusable(T_CentralUnit.class));
